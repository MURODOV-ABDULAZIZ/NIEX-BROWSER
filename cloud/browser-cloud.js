...
const SUPABASE_URL = process.env.NARIMON_CLOUD_URL || 'https://rrohtmspmuyyvswwqfsw.supabase.co';
const APIKEY = process.env.NARIMON_CLOUD_KEY || 'sb_publishable_p1fCRRYw3hyIaaXM5vtuUA_2rjn4AtE';
...
async function init({ userDataDir, logger, notify, onSub }) {
  ...
  setTimeout(pollSubscription, 6000);
}
...
module.exports = {
  init, submitFeedback, submitPayment, getSubscription, getBrowserId,
